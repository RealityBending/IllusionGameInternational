...
var demographics_consent = {
    ...
    stimulus:
        ...
        "<p style='text-align: left; margin-left: 3%; margin-right: 3%;'>Вам предлагается принять участие в исследовании, которое поможет углубить наше понимание психологии человека. Пожалуйста, внимательно прочитайте это информированное согласие.</p>" +
        ...
        "<p style='text-align: left; margin-left: 3%; margin-right: 3%;'>Данное исследование проводится доктором Домиником Маковски, преподавателем факультета психологии Университета Сассекс. Если у вас возникнут вопросы об исследовании, вы можете связаться с Домиником, написав на почту D.Makowski@sussex.ac.uk.</p>" +
        // Description
        ...
        "<p style='text-align: left; margin-left: 3%; margin-right: 3%;'>Цель данного исследования заключается в изучении влияния иллюзий на человека. В рамках исследования вам будет предложено заполнить несколько опросников и выполнить ряд заданий. В процессе будет измерено, насколько точно и быстро вы способны замечать небольшие визуальные отличия.</p>" +
        ...
        "<li style='text-align: left; margin-left: 3%; margin-right: 3%;'>Я понимаю, что мои персональные данные будут использоваться в исследовательских целях и будут обрабатываться в соответствии с законодательством о защите персональных данных.</li>" +
